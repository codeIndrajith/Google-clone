...
function WebSearchResults({ results }) {
  return (
    <div className ="w-full mx-auto px-3 sm:pb-24 md:pb-36 lg:pb-32 sm:pr-52 md:pr-52 lg:pr-52 sm:pl-[5%] md:pl-[14%] lg:pl-52 min-h-[100vh] flex flex-col justify-between">
