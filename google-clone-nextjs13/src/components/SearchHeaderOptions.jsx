...
function SearchHeaderOptions() {
  ...
  // click event function to All and Images link
  const selectTab = (tab) => {
    router.push(
  ...
  return (
    <div className="flex space-x-2 select-none border-b w-full justify-center lg:justify-start lg:pl-52 text-gray-700 text-sm">
      {/* click the all link go to the web search page. and active the all link */}
      <div
      ...
      >
        ...
        {/* click the images link go to the image search page. and active the images link.*/}
      <div
